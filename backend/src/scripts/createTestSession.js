  ...
  return {
    ...
    summary: {
      ...
      mainTopics: [
        ...
        },
        {
          ...
          description:
            "Discussion of how to apply concepts in practical scenarios and project work",
          timestamp: 115,
        },
        {
          topic: "Common Mistakes and Best Practices",
          description:
            "Overview of typical beginner errors and strategies to avoid them",
          timestamp: 170,
        },
        {
          topic: "Hands-On Exercise",
          description:
            "Guided practical exercise with step-by-step problem-solving approach",
          timestamp: 240,
        },
        {
          topic: "Advanced Tips and Resources",
          description:
            "Sharing of learning resources, practice materials, and next steps",
          timestamp: 475,
        },
      ],
      keyLearningPoints: [
      ...
      actionItems: [
        {
          description:
            "Practice fundamental concepts for at least 30 minutes daily",
          assignedTo: "learner",
        },
        {
          description:
            "Complete the exercise covered in the session independently",
          assignedTo: "learner",
        },
        {
        ...
        {
          description:
            "Prepare advanced exercises for potential follow-up session",
          assignedTo: "teacher",
        },
        {
      ...
      highlights: [
        {
          description:
            "Learner demonstrated excellent comprehension of component responsibility and interface design",
          timestamp: 385,
          importance: "high",
        },
        {
          description:
            "Breakthrough moment when learner connected theory to practical application",
          timestamp: 415,
          importance: "high",
        },
        {
          description:
            "Strong engagement with thoughtful questions throughout the session",
          timestamp: 150,
          importance: "medium",
        },
        {
          description:
            "Positive feedback and enthusiasm for continued learning",
          timestamp: 445,
          importance: "medium",
        },
      ],
    ...
    analysis: {
      engagement: {
        ...
        notes:
          "Excellent two-way communication with active participation from both parties. The learner asked insightful questions and the teacher provided clear, encouraging responses.",
      },
      teachingQuality: {
        score: 9.0,
        clarity: 9.5,
        ...
        feedback: 8.7,
        notes:
          "The teacher demonstrated exceptional clarity in explanations, adapted well to the learner's pace, and provided constructive feedback throughout the session.",
      },
      learningProgress: {
        score: 8.8,
        questionsAsked: 8,
        ...
        notes:
          "Learner showed strong progress from beginner to intermediate understanding. Demonstrated ability to apply concepts and ask relevant questions.",
      },
      overallRating: 9.0,
      recommendations: [
...
const createTestSession = async () => {
  try {
    ...
    const sessionData = {
      ...
      description:
        "A comprehensive session covering React fundamentals, hooks, and best practices for state management.",
    ...
    const summaryData = generateFakeSummary(
      transcript,
      session.skill,
      teacher.fullName,
      learner.fullName,
    ...
    console.log(
      `   Overall Rating: ${sessionSummary.analysis.overallRating}/10`,
    );
    console.log(
      `   Engagement Score: ${sessionSummary.analysis.engagement.score}/10`,
    );
    console.log(
      `   Teaching Quality: ${sessionSummary.analysis.teachingQuality.score}/10`,
    );
    console.log(
      `   Learning Progress: ${sessionSummary.analysis.learningProgress.score}/10`,
    );
    ...
    console.log("\n🔗 Quick Links:");
    console.log(
      `   Session Details: http://localhost:5173/sessions/${session._id}`,
    );
    console.log(
      `   Session Summary: http://localhost:5173/sessions/${session._id}/summary`,
    );
