...
export const notifySessionBooked = async (
  session,
  teacher,
  learner,
  io = null,
...
export const notifySessionCancelled = async (
  ...
  try {
    const cancellerName =
      cancelledBy === "teacher" ? teacher.name : learner.name;
    const notifyUserId = cancelledBy === "teacher" ? learner._id : teacher._id;
    const notifyUserName =
      cancelledBy === "teacher" ? learner.name : teacher.name;
...
export const notifySessionReviewed = async (
  session,
  reviewer,
  reviewee,
  rating,
...
export const notifyTokensPurchased = async (
  userId,
  amount,
  transactionId,
  io = null,
...
export const notifyTokensReceived = async (
  teacherId,
  amount,
  sessionId,
  learnerName,
...
export const notifyTokensSpent = async (
  learnerId,
  amount,
  sessionId,
  teacherName,
...
export const notifyLowTokenBalance = async (
  userId,
  currentBalance,
  io = null,
) => {
...
export const notifyPaymentSuccessful = async (
  userId,
  amount,
  transactionId,
  io = null,
...
export const notifyTeacherApproved = async (userId, io = null) => {
  try {
    const notification = await Notification.create({
      ...
      message: "Congratulations! You can now start teaching on skillup",
...
export const notifyAccountVerified = async (userId, io = null) => {
  try {
    const notification = await Notification.create({
      ...
      message: "Your email has been verified. Welcome to skillup!",
      actionUrl: "/dashboard",
      actionText: "Explore",
      priority: "normal",
      icon: "✅",
...
export const notifyRecordingReady = async (
  sessionId,
  teacherId,
  learnerId,
  recordingId,
...
export const notifyRecordingExpiring = async (
  userId,
  recordingTitle,
  daysLeft,
  recordingId,
