...
async function createJohnSession() {
  try {
    ...
    if (!otherUser) {
      console.log("❌ No matching partner found. Trying any other user...");
    ...
    const skillName = teachingSkill?.name || "React Development";
    const skillCategory = teachingSkill?.category || "Programming";
    ...
    const session = await Session.create({
      ...
      title: `Live Online Session: ${skillName}`,
      description: "Test session for john@example.com — React online learning",
